...
exports.index = async function(req, res, next) {
    ...
    var viewData = {
        ...
        myTotalSumToday: dashboard.myTotalSumToday,
        totalSumYesterday: dashboard.totalSumYesterday,
        myTotalSumYesterday: dashboard.myTotalSumYesterday,
        totalSumThisWeek: dashboard.totalSumThisWeek,
        myTotalSumThisWeek: dashboard.myTotalSumThisWeek,
        totalSumThisMonth: dashboard.totalSumThisMonth,
        myTotalSumThisMonth: dashboard.myTotalSumThisMonth,
        totalSumThisYear: dashboard.totalSumThisYear,
        myTotalSumThisYear: dashboard.myTotalSumThisYear,
